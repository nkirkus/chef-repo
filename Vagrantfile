...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "nkirkus-starter"
...
# config.vm.network :private_network, ip: "192.168.1.150"
 ...
 #  config.vm.network :public_network
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/noahopscode"
  #   chef.validation_client_name = "noahopscode-validator"
  #   chef.validation_key_path = ".chef/noahopscode-validator.pem"
  # end
end
